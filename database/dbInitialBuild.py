...
def createInitialData():
        ...
        db.session.commit()
        db.session.add_all([
            Studentfirst_name='John', last_name='Sullivan',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Information Systems'),
                     email_address='johnsu1@umbc'),
            Studentfirst_name='Jessica', last_name='Stack',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Information Systems'),
                     email_address='dg89092@umbc.edu'),
            Studentfirst_name='Jacob', last_name='Rosario',
                     major_id=tools.getFkValue(Major,
                                                Major.major_name,
                                                'Computer Science'),
                     email_address='crusader@umbc.edu'),
            Studentfirst_name='Anabelle', last_name='Warner',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Computer Science'),
                                                email_address='claypool@umbc.edu'),
            Studentfirst_name='Clay', last_name='Thompson',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Computer Engineering'),
                                                email_address='claytom@umbc.edu'),
            Studentfirst_name='Tom', last_name='Beagle',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Computer Engineering'),
                                                email_address='TomBeag@umbc.edu'),
            Studentfirst_name='Sally', last_name='Shoemaker',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Cyber Security'),
                     email_address='salshoe@umbc.edu'),
            Studentfirst_name='Brittany', last_name='Hacker',
                     major_id=tools.getFkValue(Major, Major.major_name,
                                                'Cyber Security'),
