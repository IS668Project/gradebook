...
def createInitialData():
        ...
        db.session.add_all([
            students(first_name='John', last_name='Sullivan',
                     major_id=db.getFkValue(majors, majors.major_name,
                                                'Information Systems'),
        ...
        db.session.add_all([
            users(first_name='John', last_name='Sullivan',
                  ...
                  user_type=db.getFkValue(user_types, user_types.user_role,
                                              'Admin'),
        ...
        db.session.commit()
        db.session.add_all([
            term_classes(class_id=db.getFkValue(classes, classes.class_abbrv,
                                                    'IS668'),
                         semester_id=db.getFkValue(semesters, semesters.semester,
                                                       'Spring'),
                         subsection='001',
                         comments='This is our first class in the test db')])
        db.session.commit()
        db.session.add_all([
            class_rosters(student_id=db.getFkValue(students,
                                                       students.first_name, 'Jessica'),
                          term_classes=db.getFkValue(term_classes,
                                                         term_classes.subsection,
                                                         '001')),
            class_rosters(student_id=db.getFkValue(students, students.first_name,
                                                       'Jacob'),
                          term_classes=db.getFkValue(term_classes,
                                                         term_classes.subsection,
                                                         '001')),
        ...
        db.session.commit()
        db.session.add_all([
            assignments(term_class_id=db.getFkValue(term_classes,
                                                        term_classes.subsection,
                                                        '001'),
        ...
        db.session.commit()
        db.session.add_all([
            user_access(user_id=db.getFkValue(users, users.first_name, 'John'),
                        term_class_id=db.getFkValue(term_classes,
                                                        term_classes.subsection,
                                                        '001')),
            user_access(user_id=db.getFkValue(users, users.first_name, 'Jessica'),
                        term_class_id=db.getFkValue(term_classes,
                                                        term_classes.subsection,
                                                        '001')),
            user_access(user_id=db.getFkValue(users, users.first_name, 'test'),
                        term_class_id=db.getFkValue(term_classes,
                                                        term_classes.subsection,
                                                        '001'))])
        db.session.commit()
